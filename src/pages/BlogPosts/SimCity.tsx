		...
		return (
			<div className='textBlock'>
				...
				<p>
					...
					<img src={systemDiagram4} alt='High-level representation of the simulation' />
				</p>

				<p>
					I finally come to the answer to my original question, and it isn’t pretty.
					<img src={systemDiagram5} alt='High-level representation of the simulation' />I really
					don’t want to parse through this, but let’s check it out. I’ll start at the top.
				</p>
